...
enemy_stats = {
    "skeleton": {"health": 30, "attack": 5, "xp": 10, "gold": 2, "items": ["potion"]},
    "rat": {"health": 10, "attack": 2, "xp": 10, "gold": 2, "items": ["potion"]},
    "spider": {"health": 15, "attack": 3, "xp": 10, "gold": 2, "items": ["potion"]},
    "goblin": {"health": 25, "attack": 4, "xp": 10, "items": ["potion"], "gold": 2},
    "orc": {"health": 40, "attack": 6, "xp": 10, "gold": 2, "items": ["potion"]},
}
